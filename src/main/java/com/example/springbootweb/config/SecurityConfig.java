...
import com.example.springbootweb.oauth.ClientResources;
import com.example.springbootweb.oauth.UserTokenService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private Filter oauth2Filter(ClientResources client, String path, SocialType socialType) {
        ...
        filter.setAuthenticationSuccessHandler(((request, response, authentication) -> response.sendRedirect("/" + socialType.getValue() + "/complate")));
